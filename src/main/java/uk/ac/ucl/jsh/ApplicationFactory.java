...
/**
 * ApplicationFactory Class using the factory pattern to create new
 * Applications. Can return a 'safe' and 'unsafe' version The 'unsafe' version
 * prints its errors to standard output and terminates instead of throwing an
 * error
 * 
 * @author Saachi Pahwa
